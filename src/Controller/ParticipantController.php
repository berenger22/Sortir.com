...
{
    /**
     * @Route("/monProfil", name="modifProfil")
     */
    public function editParticipant(Request $request, EntityManagerInterface $em, UserPasswordEncoderInterface $encoder): Response
    {
